      ...
      <section className="flex min-h-[65vh] items-center justify-center">
        <Card className="w-full max-w-2xl rounded-3xl border-border/70 bg-card/90 py-7 text-center shadow-soft">
          <CardHeader className="space-y-3 px-8">
            <Badge variant="outline" className="mx-auto rounded-xl border-primary/30 text-primary">
              Expanding soon
            </Badge>
            <CardTitle className="text-2xl text-foreground">{title}</CardTitle>
          </CardHeader>
          <CardContent className="px-8 text-sm text-muted-foreground sm:text-base">
            {description}
          </CardContent>
        </Card>
      </section>
